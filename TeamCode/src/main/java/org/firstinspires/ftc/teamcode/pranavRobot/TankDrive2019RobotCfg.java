 ...
 */
public class TankDrive2019RobotCfg extends RobotCfg {
    /**
    ...
    public enum TankDriveServoEnum implements ServoName {
        ...
        @Override
        public Class<TankDrive2019RobotCfg> getRobotCfg() {
            return TankDrive2019RobotCfg.class;
        }
    }
//    private DcMotor chest = null;


    public TankDrive2019RobotCfg(HardwareMap hardwareMap) {
        super(hardwareMap);
        ...
        clamp = hardwareMap.get(ServoControl.class, "clamp");
