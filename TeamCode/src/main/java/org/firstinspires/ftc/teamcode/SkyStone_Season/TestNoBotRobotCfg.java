...
public class TestNoBotRobotCfg extends RobotCfg {
...
//    }
    ...
    public TestNoBotRobotCfg(HardwareMap hardwareMap) { // }, Map<ServoName, Enum> servoStartPresetMap) {
        super(hardwareMap);
...
//hi
    ...
    public enum TBServos implements ServoName {
        ...
        public Class<? extends RobotCfg> getRobotCfg() {
            return TestNoBotRobotCfg.class;
        }
    }
