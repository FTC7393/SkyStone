...
public class TestBotAuto extends AbstractAutoOp<TestBotRobotCfg> {
    ...
    public StateMachine buildStates() {
        ...
        EVStateMachineBuilder b = new EVStateMachineBuilder(S.DRIVE_WITH_SENSOR_2, TeamColor.BLUE, Angle.fromDegrees(2), robotCfg.getGyro(), 0.6, 0.6, servos, robotCfg.getMecanumControl());
