...
//    private static final boolean PHONE_IS_PORTRAIT = false;
     ...
     */
//    private static final String VUFORIA_KEY = VuforiaKey.OUR_KEY;
...
//    private float phoneZRotate = 0;
    ...
    public static VuforiaManager init(CameraPlacement cameraPlacement, HardwareMap hardwareMap) {
        /*
        ...
        parameters.vuforiaLicenseKey = VuforiaKey.OUR_KEY;
        parameters.cameraDirection = cameraPlacement.getCameraChoice();
        ...
        trackables.addAll(targetsSkyStone);
        ...
        if (cameraPlacement.getCameraChoice() == BACK) {
            phoneYRotate = -90;
        } else {
            phoneYRotate = 90;
        }
        ...
        if (cameraPlacement.isPhonePortrait()) {
            phoneXRotate = 90;
        }
...
//        final float CAMERA_LEFT_DISPLACEMENT = 0;     // eg: Camera is ON the robot's center line
        ...
        float fwdDisplacementMM = cameraPlacement.getCameraForwardDisplacementInches() * mmPerInch;
        float leftDisplMM = cameraPlacement.getCameraLeftDisplacementInches() * mmPerInch;
        float vertDisplMM = cameraPlacement.getCameraVerticalDisplacemetInches() * mmPerInch;

        OpenGLMatrix robotFromCamera = OpenGLMatrix
                .translation(fwdDisplacementMM, leftDisplMM, vertDisplMM)
