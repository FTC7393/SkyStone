...
@Autonomous(name = "SkyStoneAutoVTest")
@Disabled
public class SkyStoneAutonomousVTest extends AbstractAutoOp<SkystoneRobotCfgV2> {
...
//        telemetry.addData("minusX distance sensor", robotCfg.getMinusXDistanceSensor().getDistance(DistanceUnit.CM));
    ...
    public StateMachine buildStates() {
        ...
        b.addGyroTurn(S.INIT_LIFT_ARM, S.DRIVE_1, 90, Angle.fromDegrees(1.0), 0.6);
//        b.addDrive(S.DRIVE_1, S.STOP1, Distance.fromFeet(0.5), 0.7, 0.0, 0);
//        b.addWait(S.DRIVE_1, S.STOP1, 15000L);
        addOdomDrive(null, S.DRIVE_1, b, rc, S.STOP1, 15000L, S.STOP,
                10, Angle.fromDegrees(0), 0.7, Angle.fromDegrees(90),
                100, 300, 2);
