...
public class SkystoneRi3DRobotCfg extends RobotCfg {
    ...
    public enum FutureFestServoEnum implements ServoName {
        ...
        @Override
        public Class<SkystoneRi3DRobotCfg> getRobotCfg() {
            return SkystoneRi3DRobotCfg.class;
        }
    }
    ...
    public SkystoneRi3DRobotCfg(HardwareMap hardwareMap) {
        this(hardwareMap, ServoCfg.defaultServoStartPresetMap(FutureFestServoEnum.values()));
    }
    public SkystoneRi3DRobotCfg(HardwareMap hardwareMap, Map<ServoName, Enum> servoStartPresetMap) {
        super(hardwareMap);
