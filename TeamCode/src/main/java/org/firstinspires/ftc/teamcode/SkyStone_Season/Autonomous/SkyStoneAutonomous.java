...
//        b.addDrive(S.DRIVE_LEFT, S.GRAB_BLOCK_ONE, Distance.fromFeet(0.1), 0.15, 113,0);
            ...
            b.addDrive(S.RED_SKYSTONE_LEFT, S.RED_TURN_FOR_LEFT, Distance.fromFeet(2), .25, 180, 0);
            b.addGyroTurn(S.RED_TURN_FOR_LEFT, S.RED_DRIVE_LEFT, 45, Angle.fromDegrees(2), 0.3);
            b.add(S.RED_DRIVE_LEFT, createCollectorDriveState(S.RED_PICKUP_SKYSTONE_LEFT, 45, 45, 0.13, .65, .3));
            b.add(S.RED_PICKUP_SKYSTONE_LEFT, createTimedFlywheelState(S.RED_SKYSTONE_LEFT_READY_FOR_BRIDGE, 0.4, 750));
            b.add(S.RED_SKYSTONE_LEFT_READY_FOR_BRIDGE, createCollectorDriveState(S.RED_SKYSTONE_LEFT_DRIVE_TO_BRIDGE, -90, 90, .3, .62, .3));
            b.addDrive(S.RED_SKYSTONE_LEFT_DRIVE_TO_BRIDGE, S.RED_SKYSTONE_DRIVE_TO_BUILDING_SITE, Distance.fromFeet(.02), .3, 0, 90);


//        b.addDrive(S.DRIVE_LEFT, S.GRAB_BLOCK_ONE, Distance.fromFeet(0.1), 0.15, 113,0);
            b.addDrive(S.RED_SKYSTONE_MIDDLE, S.RED_TURN_FOR_MIDDLE, Distance.fromFeet(1.2), 0.25, 180, 0);
            b.addGyroTurn(S.RED_TURN_FOR_MIDDLE, S.RED_DRIVE_MIDDLE, 45, Angle.fromDegrees(2), 0.3);
            b.add(S.RED_DRIVE_MIDDLE, createCollectorDriveState(S.RED_PICKUP_SKYSTONE_MIDDLE, 45, 45, 0.13, .65, .3));
            b.add(S.RED_PICKUP_SKYSTONE_MIDDLE, createTimedFlywheelState(S.RED_SKYSTONE_MIDDLE_READY_FOR_BRIDGE, 0.4, 750));
            b.add(S.RED_SKYSTONE_MIDDLE_READY_FOR_BRIDGE, createCollectorDriveState(S.RED_SKYSTONE_MIDDLE_TO_BRIDGE, -90, 90, .3, .605, .3));
            b.addDrive(S.RED_SKYSTONE_MIDDLE_TO_BRIDGE, S.RED_SKYSTONE_DRIVE_TO_BUILDING_SITE, Distance.fromFeet(.3), 0.30, 0, 90);


            b.addDrive(S.RED_SKYSTONE_RIGHT, S.RED_TURN_FOR_RIGHT, Distance.fromFeet(0.7), 0.25, 180, 0);
            b.addGyroTurn(S.RED_TURN_FOR_RIGHT, S.RED_DRIVE_RIGHT, 45, Angle.fromDegrees(2), 0.3);
            b.add(S.RED_DRIVE_RIGHT, createCollectorDriveState(S.RED_PICKUP_SKYSTONE_RIGHT, 45, 45, 0.13, .65, .3));
            b.add(S.PICKUP_SKYSTONE_RIGHT, createTimedFlywheelState(S.RED_SKYSTONE_RIGHT_READY_FOR_BRIDGE, 0.4, 750));
            b.add(S.RED_SKYSTONE_RIGHT_READY_FOR_BRIDGE, createCollectorDriveState(S.RED_SKYSTONE_RIGHT_TO_BRIDGE, -90, 90, .3, .65, .3));
            b.addDrive(S.RED_SKYSTONE_RIGHT_TO_BRIDGE, S.RED_SKYSTONE_DRIVE_TO_BUILDING_SITE, Distance.fromFeet(.45), 0.30, 0, 90);


            b.addDrive(S.RED_SKYSTONE_DRIVE_TO_BUILDING_SITE, S.RED_SKYSTONE_DRIVE_TO_FOUNDATION, Distance.fromFeet(1.65), 0.50, 0, 90);
            b.addDrive(S.RED_SKYSTONE_DRIVE_TO_FOUNDATION, S.RED_DROP_OFF_SKYSTONE, Distance.fromFeet(.95), 0.30, 90, 90);
            b.add(S.RED_DROP_OFF_SKYSTONE, createTimedFlywheelState(S.STOP, -1.0, 1250));
            b.add(S.FOUNDATIONMOVE_BACK_UP_TO_TURN, createCollectorDriveState(S.FOUNDATIONMOVE_TURN, -90, 90, 0.3, .5, -1.0));
            b.addGyroTurn(S.FOUNDATIONMOVE_TURN, S.FOUNDATIONMOVE_FORWARD, -90, Angle.fromDegrees(2), 0.3);
            b.addDrive(S.FOUNDATIONMOVE_FORWARD, S.LATCH_FOUNDATION, Distance.fromFeet(1.05), 0.12, 90, -90);
            b.addServo(S.LATCH_FOUNDATION, S.LATCH_FOUNDATION_RIGHT, SkystoneRobotCfg.SkystoneServoName.LEFT_FOUNDATION_MOVER_SERVO, SkystoneRobotCfg.LeftFoundationMoverServoPresets.DOWN, false);
