...
//        ResultReceiver<Boolean> cont = new BasicResultReceiver<>();
        ...
        b.addCalibrateGyro(S.INIT_GYRO,S.DRIVE_TO_STONES);

        b.addDrive(S.DRIVE_TO_STONES, StateMap.of(
                S.STOP, EndConditions.timed(1500),
                S.STOP1, EndConditions.valueCloseTo(podsSensor, 7, 1, true)
        ), RotationControls.gyro(gyro, Angle.fromDegrees(0), Angle.fromDegrees(2.5), 0.5),
                TranslationControls.sensor(podsSensor, 0.02, new Vector2D(0.7, Angle.fromDegrees(90)), 0.1, 7));
