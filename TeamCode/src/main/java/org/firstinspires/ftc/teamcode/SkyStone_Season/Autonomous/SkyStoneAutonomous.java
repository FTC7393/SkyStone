...
//                phoneCam = new OpenCvInternalCamera(OpenCvInternalCamera.CameraDirection.BACK, cameraMonitorViewId);
    ...
    public StateMachine buildStates() {
        ...
        b.addServo(S.GRABBLOCK, S.CLAMP_BLOCK, robotCfg.getSideArm().getName(), SkystoneRobotCfg.SideArmPresets.GRABBING, true);
        b.addServo(S.CLAMP_BLOCK, S.WAIT_2, robotCfg.getSideGrabber().getName(), SkystoneRobotCfg.SideGrabberPresets.CLOSED, true);
        b.addWait(S.WAIT_2, S.CARRY_SKYSTONE_1, 500L);
