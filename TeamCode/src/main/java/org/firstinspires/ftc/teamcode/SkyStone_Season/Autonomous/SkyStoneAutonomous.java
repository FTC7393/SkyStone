...
//        b.addDrive(S.DRIVE_LEFT, S.GRAB_BLOCK_ONE, Distance.fromFeet(0.1), 0.15, 113,0);
            ...
            b.addDrive(S.RED_SKYSTONE_LEFT, S.RED_TURN_FOR_LEFT, Distance.fromFeet(1.2), .25, 0, 0);
            b.addGyroTurn(S.RED_TURN_FOR_LEFT, S.RED_DRIVE_LEFT, 135, Angle.fromDegrees(2), 0.25);
            b.add(S.RED_DRIVE_LEFT, createCollectorDriveState(S.RED_PICKUP_SKYSTONE_LEFT, 135, 145, 0.13, 1, .25));
            b.add(S.RED_PICKUP_SKYSTONE_LEFT, createTimedFlywheelState(S.RED_SKYSTONE_LEFT_READY_FOR_BRIDGE, 0.4, 1100));
            b.add(S.RED_SKYSTONE_LEFT_READY_FOR_BRIDGE, createCollectorDriveState(S.RED_SKYSTONE_LEFT_DRIVE_TO_BRIDGE, -90, 90, .3, .8, .3));
            b.addDrive(S.RED_SKYSTONE_LEFT_DRIVE_TO_BRIDGE, S.RED_SKYSTONE_DRIVE_TO_BUILDING_SITE, Distance.fromFeet(.3), .3, 0, 90);


//        b.addDrive(S.DRIVE_LEFT, S.GRAB_BLOCK_ONE, Distance.fromFeet(0.1), 0.15, 113,0);
            b.addDrive(S.RED_SKYSTONE_MIDDLE, S.RED_TURN_FOR_MIDDLE, Distance.fromFeet(1.8), 0.25, 0, 0);
            b.addGyroTurn(S.RED_TURN_FOR_MIDDLE, S.RED_DRIVE_MIDDLE, 135, Angle.fromDegrees(2), 0.25);
            b.add(S.RED_DRIVE_MIDDLE, createCollectorDriveState(S.RED_PICKUP_SKYSTONE_MIDDLE, 135, 147, 0.13, 1, .25));
            b.add(S.RED_PICKUP_SKYSTONE_MIDDLE, createTimedFlywheelState(S.RED_SKYSTONE_MIDDLE_READY_FOR_BRIDGE, 0.4, 1250));
            b.add(S.RED_SKYSTONE_MIDDLE_READY_FOR_BRIDGE, createCollectorDriveState(S.RED_SKYSTONE_MIDDLE_TO_BRIDGE, 270, 90, .3, 0.65, .3));
            b.addDrive(S.RED_SKYSTONE_MIDDLE_TO_BRIDGE, S.RED_SKYSTONE_DRIVE_TO_BUILDING_SITE, Distance.fromFeet(.15), 0.30, 0, 90);
            ...
            b.add(S.RED_DROP_OFF_SKYSTONE, createTimedFlywheelState(S.RED_FOUNDATIONMOVE_BACK_UP_TO_TURN, -1.0, 1250));
            b.add(S.RED_FOUNDATIONMOVE_BACK_UP_TO_TURN, createCollectorDriveState(S.RED_FOUNDATIONMOVE_TURN, 270, 90, 0.3, .5, -1.0));
            ...
            b.addDrive(S.RED_DRIVE_BACK_TO_BRIDGE, S.RED_AVOID_ROBOT, Distance.fromFeet(0.6), 0.3, 180, 270);
