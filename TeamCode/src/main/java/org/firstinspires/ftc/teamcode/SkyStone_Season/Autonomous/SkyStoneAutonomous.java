...
//        b.addDrive(S.DRIVE_LEFT, S.GRAB_BLOCK_ONE, Distance.fromFeet(0.1), 0.15, 113,0);
            ...
            b.addDrive(S.RED_SKYSTONE_RIGHT, S.RED_TURN_FOR_RIGHT, Distance.fromFeet(2.3), 0.25, 0, 0);
            b.addGyroTurn(S.RED_TURN_FOR_RIGHT, S.RED_DRIVE_RIGHT, 135, Angle.fromDegrees(2), 0.25);
            b.add(S.RED_DRIVE_RIGHT, createCollectorDriveState(S.PICKUP_SKYSTONE_RIGHT, 135, 135, 0.13, 1, .25));
            ...
            b.addDrive(S.RED_SKYSTONE_RIGHT_TO_BRIDGE, S.RED_SKYSTONE_DRIVE_TO_BUILDING_SITE, Distance.fromFeet(0.1), 0.30, 0, 90);


            b.addDrive(S.RED_SKYSTONE_DRIVE_TO_BUILDING_SITE, S.STOP, Distance.fromFeet(1.65), 0.50, 0, 90);
            b.addDrive(S.RED_SKYSTONE_DRIVE_TO_FOUNDATION, S.RED_DROP_OFF_SKYSTONE, Distance.fromFeet(.95), 0.30, 90, 180);
            b.add(S.RED_DROP_OFF_SKYSTONE, createTimedFlywheelState(S.STOP, -1.0, 1250));
            b.add(S.RED_FOUNDATIONMOVE_BACK_UP_TO_TURN, createCollectorDriveState(S.RED_FOUNDATIONMOVE_TURN, -90, 90, 0.3, .5, -1.0));
            b.addGyroTurn(S.RED_FOUNDATIONMOVE_TURN, S.RED_FOUNDATIONMOVE_FORWARD, -90, Angle.fromDegrees(2), 0.3);
            b.addDrive(S.RED_FOUNDATIONMOVE_FORWARD, S.RED_LATCH_FOUNDATION, Distance.fromFeet(1.05), 0.12, 90, -90);
            ...
            b.addDrive(S.RED_DRIVE_BACK_TO_BRIDGE, S.RED_AVOID_ROBOT, Distance.fromFeet(0.9), 0.3, 0, 270);
            b.addDrive(S.RED_AVOID_ROBOT, S.RED_PARK, Distance.fromFeet(2), 0.3, 90, 270);
            b.addDrive(S.RED_PARK, S.STOP, Distance.fromFeet(0.4), 0.3, 0, 270);
        }
